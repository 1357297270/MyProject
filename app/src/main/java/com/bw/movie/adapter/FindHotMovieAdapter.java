...
public class FindHotMovieAdapter extends RecyclerView.Adapter<FindHotMovieAdapter.ViewHolder> {
    List<Popular_Bean.ResultBean> list;
    Context context;

    public FindHotMovieAdapter(List<Popular_Bean.ResultBean> list, Context context) {
        this.list = list;
